...
login:
	${INFO} "Logging in to Docker registry $$DOCKER_REGISTRY... $$DOCKER_USER $$DOCKER_PASSWORD"
	@ docker login -u $$DOCKER_USER  -e $$DOCKER_EMAIL -p $$DOCKER_PASSWORD $(DOCKER_REGISTRY_AUTH)
